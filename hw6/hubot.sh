...
# Check that hubot is actually installed...
if [ ! -e $DIR/node_modules/.bin/hubot ]
then

    echo ""
    echo "OH NO! You don't have Hubot installed."
    echo ""
...
# npm installs the hubot executable within node_modules/.bin, so let's
