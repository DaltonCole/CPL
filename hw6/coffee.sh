...
# Check that coffee is actually installed...
if [ ! -e $DIR/node_modules/.bin/coffee ]
then

    echo ""
    echo "OH NO! You don't have CoffeeScript installed."
    echo ""
...
# npm installs the coffee executable within node_modules/.bin, so let's
